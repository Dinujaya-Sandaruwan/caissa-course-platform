...
export default function StudentAccountPage() {
  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.refresh();
      // Need a full reload to refresh the profile in the navbar if picture changed
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8 animate-[fade-in-up_0.4s_ease-out]">
      <div>
      ...
      <div className="space-y-8">
            ...
            <div className="flex flex-col items-center sm:items-start sm:flex-row gap-6 mb-8">
              ...
              <div className="text-center sm:text-left pt-2">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Recommend 1:1 ratio, max 5MB. Click the avatar to upload a new
                  one.
                </p>
                {photoError && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="sm:col-span-1">
                ...
                <input
                  ...
                  className={inputClasses}
                />
                <p className="text-[11px] text-gray-400 mt-1.5 ml-1 font-medium italic">
                  * Displayed in leaderboards (optional)
                </p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
          ...
          <div className="p-4 bg-slate-50 border border-gray-100 rounded-2xl mb-4 max-w-lg">
          ...
          {/* Phone Change Flow */}
          {isChangingPhone && (
            <div className="mt-6 p-5 sm:p-6 border border-red-100 bg-gradient-to-br from-red-50/50 to-white rounded-2xl shadow-[0_4px_20px_rgb(220,38,38,0.05)] animate-[fade-in_0.3s_ease-out] max-w-lg">
              ...
              {phoneStep === "enter_new" && (
                <div className="space-y-4">
                  <div className="flex items-center gap-2 text-green-600 bg-green-50 p-3 rounded-lg text-sm font-semibold mb-2">
                    <CheckCircle2 className="w-4 h-4" /> Verified Current Number
                  </div>
                  <p className="text-sm text-gray-600">
