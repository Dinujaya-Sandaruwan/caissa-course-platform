  ...
  return (
    <section className="relative bg-white min-h-[85vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#e5e7eb_1px,transparent_1px),linear-gradient(to_bottom,#e5e7eb_1px,transparent_1px)] bg-[size:4rem_4rem] opacity-40 animate-[pan-grid_40s_linear_infinite]"></div>
        {/* Abstract Glows */}
      ...
      {/* Full-width flex layout: left side contained, right side breaks out */}
      <div className="relative z-10 w-full flex flex-col lg:flex-row items-center">
        {/* Text Content Area — stays within max-width container */}
        <div className="w-full lg:w-[45%] flex flex-col items-center lg:items-start text-center lg:text-left px-6 sm:px-10 lg:pl-[max(2rem,calc((100vw-80rem)/2+2rem))] lg:pr-8 py-12 lg:py-0">
